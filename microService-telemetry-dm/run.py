...
import asyncio, requests, datetime, os, json, time
    ...
    def __init__(self):
        ...
        try:
            ...
            with open(configFile) as json_file:
                ...
                self.storageContainer = config['azureResource']['StorageContainerDM']
                ...
                self.consumerGroup = config['azureResource']['IoT-ConsumerGroupDM']
